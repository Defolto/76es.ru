...
$mail->addAddress('mirokon76@mail.ru');     // Кому будет уходить письмо quick-count@yandex.ru
...
$mail->Body    = '' .$name . ' оставил(а) заявку с сайта, его(её) телефон ' .$phone. '<br> Его почта ' .$email;
$mail->AltBody = '';
